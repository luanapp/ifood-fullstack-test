...
public class OrderData {
  ...
  public static final Date ORDER1_CREATED = Date.from(Instant.parse(ORDER1_CREATED_STR));
  public static final String ORDER1_CONFIRMED_STR = "2017-10-01T12:30:00Z";
  public static final Date ORDER1_CONFIRMED = Date.from(Instant.parse(ORDER1_CONFIRMED_STR));
  ...
  public static final Date ORDER2_CREATED = Date.from(Instant.parse(ORDER2_CREATED_STR));
  public static final String ORDER2_CONFIRMED_STR = "2018-07-11T15:30:00Z";
  public static final Date ORDER2_CONFIRMED = Date.from(Instant.parse(ORDER2_CONFIRMED_STR));
