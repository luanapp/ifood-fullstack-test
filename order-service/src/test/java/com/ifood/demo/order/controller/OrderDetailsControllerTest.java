...
public class OrderDetailsControllerTest {
  ...
  @InjectMocks private OrderDetailsController orderDetailsController;
  ...
  public void getOrderDetails() throws Exception {
    ...
    when(orderDetailsService.getOrderDetails(anyString(), anyString(), eq(null), eq(null),
        eq(null))).thenReturn(orderDetails);
  ...
  public void getOrderDetails_NoStartDate() throws Exception {
    ...
    verify(orderDetailsService, times(0)).getOrderDetails(eq(null), anyString(), eq(null), eq(null),
        eq(null));
  }
  ...
  public void getOrderDetails_NoEndDate() throws Exception {
    ...
    verify(orderDetailsService, times(0)).getOrderDetails(anyString(), eq(null), eq(null), eq(null),
        eq(null));
  }
}